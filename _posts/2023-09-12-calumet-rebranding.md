...
tags: ["design", "web"]
image:
  gallery: /assets/images/calumet_ci/
  thumbnail: calumet_ci_thumbnail.webp
  feature: calumet_ci_thumbnail.webp
  old: calumet_ci_old_thumb.webp
  old02: calumet_ci_old02_thumb.webp
  image01: calumet_ci01.webp
...
<div class="post-media post-media--two">
  <img src="{{ page.image.gallery }}{{ page.image.old02 }}" alt="">
  <img src="{{ page.image.gallery }}{{ page.image.old }}" alt="">
</div>
